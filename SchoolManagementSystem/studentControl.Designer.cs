namespace SchoolManagementSystem
{
    partial class studentControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            lbStopped = new Label();
            btnStudentStop = new Button();
            btnRecovery = new Krypton.Toolkit.KryptonButton();
            ...
            btnInsert.StateCommon.Border.GraphicsHint = Krypton.Toolkit.PaletteGraphicsHint.AntiAlias;
            ...
            btnExport.StateCommon.Border.GraphicsHint = Krypton.Toolkit.PaletteGraphicsHint.AntiAlias;
            ...
            // panel5
            // 
            panel5.Controls.Add(btnStudentStop);
            panel5.Controls.Add(lbStopped);
            panel5.Controls.Add(labelStopped);
            panel5.Controls.SetChildIndex(labelStopped, 0);
            panel5.Controls.SetChildIndex(lbStopped, 0);
            panel5.Controls.SetChildIndex(btnStudentStop, 0);
            panel5.Controls.SetChildIndex(lb4, 0);
            panel5.Controls.SetChildIndex(btnDelete, 0);
            panel5.Controls.SetChildIndex(lb6, 0);
            panel5.Controls.SetChildIndex(lb2, 0);
            panel5.Controls.SetChildIndex(btnUpdate, 0);
            panel5.Controls.SetChildIndex(lb3, 0);
            panel5.Controls.SetChildIndex(lb1, 0);
            panel5.Controls.SetChildIndex(btnInformation, 0);
            panel5.Controls.SetChildIndex(lb5, 0);
            // 
            // panel1
            // 
            panel1.Controls.Add(btnRecovery);
            panel1.Controls.SetChildIndex(btnExport, 0);
            panel1.Controls.SetChildIndex(btnInsert, 0);
            panel1.Controls.SetChildIndex(btnRecovery, 0);
            // 
            // labelStopped
            // 
            labelStopped.AutoSize = true;
            labelStopped.Font = new Font("Poppins", 12F);
            labelStopped.Location = new Point(387, 5);
            labelStopped.Name = "labelStopped";
            labelStopped.Size = new Size(87, 28);
            labelStopped.TabIndex = 24;
            labelStopped.Text = "Stopped :";
            // 
            // lbStopped
            // 
            lbStopped.AutoSize = true;
            lbStopped.Font = new Font("Poppins", 12F);
            lbStopped.Location = new Point(476, 5);
            lbStopped.Name = "lbStopped";
            lbStopped.Size = new Size(42, 28);
            lbStopped.TabIndex = 24;
            lbStopped.Text = "000";
            lbStopped.TextAlign = ContentAlignment.MiddleRight;
            // 
            // btnStudentStop
            // 
            btnStudentStop.Location = new Point(524, 10);
            btnStudentStop.Name = "btnStudentStop";
            btnStudentStop.Size = new Size(39, 17);
            btnStudentStop.TabIndex = 25;
            btnStudentStop.UseVisualStyleBackColor = true;
            // 
            // btnRecovery
            // 
            btnRecovery.Location = new Point(566, 7);
            btnRecovery.Margin = new Padding(3, 2, 3, 2);
            btnRecovery.Name = "btnRecovery";
            btnRecovery.OverrideDefault.Back.Color1 = Color.Blue;
            btnRecovery.OverrideDefault.Back.Color2 = Color.Blue;
            btnRecovery.OverrideDefault.Border.Color1 = Color.Blue;
            btnRecovery.OverrideDefault.Border.Color2 = Color.Blue;
            btnRecovery.OverrideDefault.Border.Rounding = 5F;
            btnRecovery.OverrideDefault.Border.Width = 1;
            btnRecovery.OverrideDefault.Content.ShortText.Color1 = Color.White;
            btnRecovery.OverrideDefault.Content.ShortText.Color2 = Color.White;
            btnRecovery.PaletteMode = Krypton.Toolkit.PaletteMode.ProfessionalSystem;
            btnRecovery.Size = new Size(99, 26);
            btnRecovery.StateCommon.Back.Color1 = Color.Blue;
            btnRecovery.StateCommon.Back.Color2 = Color.Blue;
            btnRecovery.StateCommon.Border.Color1 = Color.Blue;
            btnRecovery.StateCommon.Border.Color2 = Color.Blue;
            btnRecovery.StateCommon.Border.GraphicsHint = Krypton.Toolkit.PaletteGraphicsHint.AntiAlias;
            btnRecovery.StateCommon.Border.Rounding = 5F;
            btnRecovery.StateCommon.Border.Width = 1;
            btnRecovery.StateCommon.Content.ShortText.Color1 = Color.White;
            btnRecovery.StateCommon.Content.ShortText.Color2 = Color.White;
            btnRecovery.StateCommon.Content.ShortText.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnRecovery.StateTracking.Back.Color1 = Color.MediumBlue;
            btnRecovery.StateTracking.Back.Color2 = Color.MediumBlue;
            btnRecovery.StateTracking.Border.Color1 = Color.MediumBlue;
            btnRecovery.StateTracking.Border.Color2 = Color.MediumBlue;
            btnRecovery.StateTracking.Border.Rounding = 5F;
            btnRecovery.StateTracking.Border.Width = 1;
            btnRecovery.TabIndex = 18;
            btnRecovery.Values.DropDownArrowColor = Color.Empty;
            btnRecovery.Values.Text = "Recovery";
        ...
        private Label lbStopped;
        private Label labelStopped;
        private Button btnStudentStop;
        protected Krypton.Toolkit.KryptonButton btnRecovery;
    }
}
